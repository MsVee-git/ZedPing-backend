...
function buildLiveSystem(agent, version) {
  ...
  return {
    ...
    prompt: [
      ...
      unknownHandoff
        ? 'If the answer is unavailable or incomplete in the business facts below, give any directly supported part of the answer first, then naturally say that the team needs to confirm the remaining detail and offer to connect the customer with them. End that response with the exact marker [[HANDOFF]]. Do not promise a response time, availability, booking, quotation, stock, or action that has not happened.'
